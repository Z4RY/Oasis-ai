      ...
      <div className="w-full max-w-md">
        ...
        <Card className="minimal-card animate-slide-up">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl text-foreground font-light">Create Your Account</CardTitle>
            <CardDescription>Start your writing journey with Oasis</CardDescription>
          </CardHeader>
          <CardContent>
            {error && (
            ...
            <p className="text-center text-sm text-muted-foreground mt-6">
              ...
              <Link href="/auth/signin" className="text-foreground hover:text-foreground/80 font-medium transition-colors">
                Sign in
              </Link>
            </p>
          </CardContent>
